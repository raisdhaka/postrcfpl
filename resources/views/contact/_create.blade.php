  ...
  @endphp
    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('contact_id', $contactNo, ['class' => 'form-control','placeholder' => __('lang_v1.contact_id')]); !!}
                    </div>
                    <p class="help-block">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    {!! Form::label('address_line_1', __('Address') . ':') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="fa fa-address-card"></i>
                        </span>
                        {!! Form::text('address_line_1', null, ['class' => 'form-control','placeholder' => __('business.address')]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 lead_additional_div">
                  <div class="form-group">
                      {!! Form::label('user_id', __('lang_v1.Stockist') . ':*' ) !!}
                      <div class="input-group">
                          <span class="input-group-addon">
                              <i class="fa fa-user"></i>
                          </span>
            ...
            @if(config('constants.enable_contact_assign') && $type !== 'lead')
                <div class="col-md-4">
                      <div class="form-group">
                          {!! Form::label('assigned_to_users', __('Stockist') . ':' ) !!}
                          <div class="input-group">
                              <span class="input-group-addon">
                                  <i class="fa fa-user"></i>
                              </span>
                              {!! Form::select('assigned_to_users', $stockists ?? [], null , ['class' => 'form-control select2', 'id' => 'assigned_to_users',  'style' => 'width: 100%;']); !!}
                          </div>
                      </div>
                </div>
            @endif
                ...
                <div class="col-md-4">
                      <div class="form-group">
                            {!! Form::label('refered_id', __('Reffer User ID') . ':' ) !!}
                            {!!Form::select('user_refered_id', $contacts ?? [], null ,['class' => 'form-control select2', 'id' => 'user_refered_id', 'style' => 'width: 100%;'])!!}
                      </div>
                </div>
                <div class="col-md-4">
                      <div class="form-group">
                            {!! Form::label('refered_id', __('Placement User ID') . ':' ) !!}
                            {!!Form::select('refered_id', $contacts ?? [], null ,['class' => 'form-control select2', 'id' => 'refered_id', 'style' => 'width: 100%;', 'onchange' => 'getChild()'])!!}
                      </div>
                </div>
                
                <div class="col-md-4">
                  <div class="form-group">
                        {!! Form::label('available_child', __('Placement Side') . ':' ) !!}
                        {!!Form::select('available_child',  [], null ,['class' => 'form-control', 'id' => 'available_child', 'style' => 'width: 100%;'])!!}
